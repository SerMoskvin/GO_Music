...
type ProgrammDistributionManager struct {
	*BaseManager[int, domain.ProgrammDistribution, *domain.ProgrammDistribution]
	db *sql.DB
}
...
func NewProgrammDistributionManager(
	...
	return &ProgrammDistributionManager{
		BaseManager: NewBaseManager[int, domain.ProgrammDistribution, *domain.ProgrammDistribution](repo, logger, txTimeout),
		db:          db,
	}
}
