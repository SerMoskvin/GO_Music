...
type SubjectDistributionManager struct {
	*BaseManager[int, domain.SubjectDistribution, *domain.SubjectDistribution]
	db *sql.DB
}
...
func NewSubjectDistributionManager(
	...
	return &SubjectDistributionManager{
		BaseManager: NewBaseManager[int, domain.SubjectDistribution, *domain.SubjectDistribution](repo, logger, txTimeout),
		db:          db,
	}
}
