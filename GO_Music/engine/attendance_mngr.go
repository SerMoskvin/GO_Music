...
type StudentAttendanceManager struct {
	*BaseManager[int, domain.StudentAttendance, *domain.StudentAttendance]
	db *sql.DB
}
...
func NewStudentAttendanceManager(
	...
	return &StudentAttendanceManager{
		BaseManager: NewBaseManager[int, domain.StudentAttendance, *domain.StudentAttendance](repo, logger, txTimeout),
		db:          db,
	}
}
